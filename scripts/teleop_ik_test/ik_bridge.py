...
from spot_ik import SpotModel   # <-- importa tu clase (ajusta el nombre del archivo si no se llama spot_model.py)
...
class IKBridge:
    def __init__(self):
        ...
        self.pub_servos = rospy.Publisher("/servo_positions", Int32MultiArray, queue_size=1)
    ...
    def callback(self, msg):
        ...
        try:
            ...
            # Publicar en ROS
            msg_out = Int32MultiArray(data=servo_positions)
